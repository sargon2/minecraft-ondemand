...
The only **required** configuration value is `DOMAIN_NAME`.  This value should be the exact domain name you purchased.  During setup, a dedicated subdomain hosted zone will be created.  After deployment, add an NS record for that subdomain in your parent DNS zone using the `SubdomainHostedZoneNameServers` stack output.
...
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| DOMAIN_NAME                   | **Required** Parent domain name for the Minecraft subdomain. The parent zone may live in another AWS account or DNS provider if you manually delegate the subdomain using the `SubdomainHostedZoneNameServers` output.                                                                                                                                                                                                                                                                                                                                      | --                   |
| SUBDOMAIN_PART                | Name of the subdomain part to be used for creating a delegated hosted zone (minecraft.example.com). This subdomain should not already be in use. Add the stack's `SubdomainHostedZoneNameServers` output as an NS record in your parent DNS zone after deployment.                                                                                                                                                                                                                                                                                         | `minecraft`          |
